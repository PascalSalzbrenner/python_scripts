...
# input files
# configuration_average_full_sym_hr.dat generated by the symmetrise script; wannier90.win for static
...
if not os.path.exists("./average_primitive_model"):
    os.mkdir("./average_primitive_model")
...
with open("average_primitive_model/primitive_cell.win", "w") as win_out:
     win_out.write("\n".join(win_lines))

################################################## write _centres.xyz file ##################################################

# enforcing the atomic positions for reading into the TB model
...
with open("average_primitive_model/primitive_cell_centres.xyz", "w") as xyz_out:
    xyz_out.write("\n".join(xyz_atomic_lines))

################################################## read, process, and write _hr.dat data ##################################################

# read data from wannier90_hr.dat file
hr_in = open("configuration_average_full_sym_hr.dat", "r")
...
with open("average_primitive_model/primitive_cell_hr.dat", "w") as hr_out:
