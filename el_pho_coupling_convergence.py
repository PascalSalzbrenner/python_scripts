...
vb_plotfile.write("set terminal postscript eps colour font 'Helvetica,20'\n")
...
cb_plotfile.write("set terminal postscript eps colour font 'Helvetica,20'\n")
...
bg_plotfile.write("set terminal postscript eps colour font 'Helvetica,20'\n")
